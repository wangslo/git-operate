...
<p><img title=10个迅速提升你Git水平的提示_ 图片3 class="lazyload" src="http://img.mukewang.com/55bf107f0001efef08550326.png" alt="图片描述" /></p>
...
<p><img title=10个迅速提升你Git水平的提示_ 图片4 class="lazyload" src="http://img.mukewang.com/55bf10ff0001a39b04790459.png" alt="图片描述" /></p>
<p>然而，一个<code>git reflog</code>命令则展示了一次commit (<code>b1b0ee9</code>—<code>HEAD@{4}</code>)，它正是我刚才进行强制重置时弄丢的：</p>
<p><img title=10个迅速提升你Git水平的提示_ 图片5 class="lazyload" src="http://img.mukewang.com/55bf115a0001c6cd07740223.png" alt="图片描述" /></p>
...
<p><img title=10个迅速提升你Git水平的提示_ 图片6 class="lazyload" src="http://img.mukewang.com/55bf11d800015a3c03840329.png" alt="图片描述" /></p>
<p>然后再看看在 <code>add</code> 命令中添加 <code>-p</code> 参数是怎样的？</p>
<p><img title=10个迅速提升你Git水平的提示_ 图片7 class="lazyload" src="http://img.mukewang.com/55bf11e100012f3404470351.png" alt="图片描述" /></p>
...
<p><img title=10个迅速提升你Git水平的提示_ 图片8 class="lazyload" src="http://img.mukewang.com/55bf122b00014f3104290436.png" alt="图片描述" /></p>
<p>正如你所看到的，我们添加了第一行和第三行而忽略了第二行。之后你可以查看仓库状态之后并进行提交。</p>
<p><img title=10个迅速提升你Git水平的提示_ 图片9 class="lazyload" src="http://img.mukewang.com/55bf12750001d28a07140286.png" alt="图片描述" /></p>
...
<p><img title=10个迅速提升你Git水平的提示_ 图片10 class="lazyload" src="http://img.mukewang.com/55bf12ea0001692306770434.png" alt="图片描述" /></p>
<p>然后会要求你为新的commit录入提交信息。这一过程本质上重写了你的commit历史。</p>
<p><img title=10个迅速提升你Git水平的提示_ 图片11 class="lazyload" src="http://img.mukewang.com/55bf13110001ce9a06180452.png" alt="图片描述" /></p>
...
<p><img title=10个迅速提升你Git水平的提示_ 图片12 class="lazyload" src="http://img.mukewang.com/55bf13d30001ad5306150046.png" alt="图片描述" /></p>
...
<p><img title=10个迅速提升你Git水平的提示_ 图片13 class="lazyload" src="http://img.mukewang.com/55bf15770001931307310292.png" alt="图片描述" /></p>
...
<p><img title=10个迅速提升你Git水平的提示_ 图片14 class="lazyload" src="http://img.mukewang.com/55bf15ce00012a7d05280210.png" alt="图片描述" /></p>
...
<p><img title=10个迅速提升你Git水平的提示_ 图片15 class="lazyload" src="http://img.mukewang.com/55bf167600014dc106760257.png" alt="图片描述" /></p>
<p>我切换到想被<code>cherry-pick</code>应用到的这个分支上去，然后运行了如下命令：</p>
<pre class="prettyprint"><code>git cherry-pick [commit_hash]</code></pre>
<p><img title=10个迅速提升你Git水平的提示_ 图片16 class="lazyload" src="http://img.mukewang.com/55bf16930001dcda06650337.png" alt="图片描述" /></p>
